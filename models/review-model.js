...
// Post middleware does not have acces to next function
reviewSchema.post('save',function(){
    // this points to current review
    //  this will not work because we are creating Review model after this middleware function
    // Review.calculateAverageRatings(this.tour)

    // for this problem we call the constructor of Review  model
